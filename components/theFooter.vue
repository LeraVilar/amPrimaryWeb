<template>
  <footer class="academy-footer">
    ...
    <div class="academy-footer__bottom">
      <a style="color: #644c5c; text-decoration: none; width: 100%;" :href="link + '/uploads/PUBLI_Ch_NA_Ya_OFERTA_db374e4233.pdf'" target="_blank" class="academy-footer__bottom-column">
        Публичная оферта
      </a>
