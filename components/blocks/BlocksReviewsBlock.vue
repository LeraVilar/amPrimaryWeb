  ...
  <div id="reviews" class="reviews-block">
    ...
    <div ref="wrapperSlider" class="swiper">
      ...
      >
        ...
        >
          <p v-html="item.content" ref="heightDetails"></p>
...
const optionsArray = [
  ...
  {
    key: "school",
    label: "Отзывы Цикл вебинаров по беременности",
  },
  {
    key: "repro",
    label: "Проект «Репро»",
...
.itemSlider {
  ...
  &::before {
    ...
    width: 100%;
    height: 70px;
    background: rgba(236, 231, 225, 0.3);
    position: absolute;
    bottom: 0px;
    left: 0;
    border-radius: 15px;
    -webkit-box-shadow: 0px -98px 41px -17px rgba(236, 231, 225, 0.9) inset;
    -moz-box-shadow: 0px -98px 41px -17px rgba(236, 231, 225, 0.9) inset;
    box-shadow: 0px -98px 41px -17px rgba(236, 231, 225, 0.9) inset;
  }
  &::after {
    content: "";
    height: 30px;
