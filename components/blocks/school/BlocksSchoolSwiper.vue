<template>
  ...
  <elements-modals-keeper :is-modal-opened="isModalOpened" @close="switchModal">
    ...
    <ul class="main-swiper__modal-list">
      <li
        class="main-swiper__modal-item"
        v-for="(item, i) in modalInfo.items"
        :key="i"
        v-html="item"
      />
    </ul>
...
const slidesArray = [
  ...
  },
  {
    ...
    text: "Врач-педиатр, невролог. Технический директор Территория здоровья ",
    photo: "4",
    items: [
      "— Врач-педиатр, невролог",
      `— едицинский редактор проектов "Виртуальный пациент" группы компаний Геотар-медиа`,
      `— Технический директор Территория здоровья`,
    ],
  },
  {
    ...
    items: [
      ...
      `— Автор вебинара "Аюрведа для жизни" и вебинара по железодефицитной анемии`,
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      `— Автор вебинара "Патронажное искусство" и вебинара подготовки консультантов по грудному вскармливанию`,
  ...
  },
  {
    ...
    items: [
      ...
      `— Автор вебинара йоги "Свобода быть собой"`,
