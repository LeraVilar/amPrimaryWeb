<template>
  <div class="school-tariff">
    <h2 class="school-tariff__title" id="school-tariff__title">Тарифы</h2>
    <div class="school-tariff__tabs-wrapper">
      <div
        ...
        @click="activeTab = 1"
      >
        <h3 class="school-tariff__tab-title">По пакетам</h3>
        <div class="school-tariff__tab-label">Оптимальное наполнение</div>
      ...
      <div
        ...
        @click="activeTab = 2"
      >
        <h3 class="school-tariff__tab-title">По триместрам</h3>
        <div class="school-tariff__tab-label">Спецпредложение</div>
        <svg-arrow-right class="school-tariff__tab-arrow" />
      </div>
    </div>
    <div v-if="activeTab === 1" class="school-tariff__packages-list">
      ...
      >
        <div>
          ...
          <div
            v-for="(programObject, i) in item.program"
            :key="i"
            class="school-tariff__package-program"
          >
            {{ programObject.label }}
            <ul class="school-tariff__package-program-list">
              <li
                v-for="(programItem, i) in programObject?.items"
                :key="i"
                class="school-tariff__package-program-item"
              >
                {{ programItem }}
              </li>
            </ul>
        ...
        <div>
          <div class="school-tariff__with-support-block">
            <div class="school-tariff__price-label">
              ...
              <div class="school-tariff__tooltip">
                ...
                — Обратную связь от главного эксперта Территории здоровья Элисо
                Джобава. Каждый день (кроме субботы, воскресенья и праздников) в
                плановом порядке в течение суток доктор Элисо ответит на вопросы
                участниц<br /><br />
              </div>
            </div>
          ...
          <div class="school-tariff__with-support-block">
            <div class="school-tariff__price-label">Без обратной связи</div>
            <div class="school-tariff__price">
              {{ item?.costWithoutSupport }}
            </div>
            <elements-buttons-secondary
              :link="
                'https://dzhobava.com/account/?specs=products&page=' + item.link
              "
              title="Купить тариф"
            />
          </div>
    ...
    <div v-else class="school-tariff__trimester-list">
      <div
        ...
        :key="i"
        class="school-tariff__trimester-item"
      >
        <div class="school-tariff__trimester-left-column">
          ...
          <div class="school-tariff__with-support-block desktop-only">
            ...
            <elements-buttons-secondary
              :link="
                'https://dzhobava.com/account/?specs=webinars&page=' +
                trimester.link
              "
              title="Купить тариф"
            />
        ...
        <div class="school-tariff__trimester-right-column">
          <div
            v-for="(programObject, i) in trimester.program"
            :key="i"
            class="school-tariff__package-program"
          >
            {{ programObject.label }}
...
const packages = [
  {
    ...
    title: "Полный цикл вебинаров по беременности",
    ...
    program: [
      {
        ...
        items: ["— Подготовка к родам", "— Послеродовый период"],
      },
      {
        label: "Уроки из 1-ого блока «1 триместр»",
        items: [
      ...
      },
      {
        ...
        items: ["— Урок остеопата", "— Урок врача аюрведы"],
      },
      {
        label: "Все материалы, бонусы и подарки 6-ого блока",
      },
  ...
  },
  {
    ...
    program: [
      ...
      {
        label: "Уроки из 1-ого блока «1 триместр»",
        items: ["— Урок психолога", "— Урок маммолога"],
      },
      {
        label: "Уроки из 3-ого блока «3 триместр»",
        items: ["— Урок остеопата", "— Урок врача аюрведы"],
  ...
  },
  {
    ...
    program: [
      ...
      },
      {
        ...
        items: ["— Урок гинеколога", "— Урок врача аюрведы"],
      },
      {
        label: "Дополнительные материалы",
        items: [
    ...
    program: [
      {
        ...
        items: ["— Урок гинеколога", "— Урок психолога", "— Урок доулы"],
      },

      {
        label: "Уроки из 1-ого блока «1 триместр»",
        items: ["— Урок психолога", "— Урок маммолога", "— Урок йоги"],
      },
      {
        label: "Уроки из 3-ого блока «3 триместр»",
        items: ["— Урок врача аюрведы", "— Урок остеопата"],
      },
      {
        label: "Подарки",
        items: [
