...
const tabs = [
  {
    title: "Гайды. Методички. Вебинары",
  ...
  {
    title: "Все о беременности и как ее достичь",
  ...
  {
    title: "Специалистам",
    text: "Продукты позволяющие перенять опыт и знания специалиста международного уровня",
    image: "5",
    link: "/forMedWorkers",
    btn: "Подробнее",
  },
