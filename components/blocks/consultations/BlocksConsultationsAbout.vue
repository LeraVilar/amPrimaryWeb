...
<<<<<<< HEAD
            Каждый специалист гинеколог команды — это профессионал высокого
            уровня. Каждый имеет свою специализацию и любимые темы, обладает
            всеми необходимыми навыками и собственными “фишками”. Всё лечение мы
            строим совместно под моим контролем.
=======
