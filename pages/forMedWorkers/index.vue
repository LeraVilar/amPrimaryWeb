<template>
  <div class="med-workers-page section-container">
    <blocks-workers-card-list
      :med="true"
      :data="store.getDataMedWor"
      @openModal="openModal"
    />
    <blocks-description-minor
      class="section-block"
      label="Об авторе"
      :title="descriptionTitle"
      :list-items="descriptionItems"
    />
    ...
    >
      ...
      <h4 class="med-workers-page__secondary-title">О чем поговорим?</h4>
      ...
      <div class="med-workers-page__author-block">
        ...
        <div class="med-workers-page__about-author">
          <div class="med-workers-page__author-label">Автор Вебинара</div>
...
const descriptionTitle =
  "Элисо Джобава — профессор, доктор медицинских наук, специалист по трудным и сложным беременностям";
